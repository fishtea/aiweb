...
> Gemini 是 Google DeepMind 开发的原生多模态大模型系列，深度融合文本、图像、音频、视频和代码理解能力。按 2026-07-06 可核验的官方模型文档，生产选型重点是 Gemini 2.5 Pro、2.5 Flash、2.0 Flash 以及仍在大量系统中使用的 1.5 Pro / Flash。
...
| 场景 | 推荐 |
|------|------|
| 复杂推理、长文档、多模态分析 | Gemini 2.5 Pro |
| 低延迟、多模态问答、批量抽取 | Gemini 2.5 Flash / 2.0 Flash |
| 超长上下文文档或视频理解 | Gemini 1.5 Pro / 2.5 Pro |
